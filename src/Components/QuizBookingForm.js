...
const QuizBookingForm = () => {
  ...
  return (
    <div className="quiz-booking-form" style={{ paddingLeft: '10px' }}>
        ...
        <Row>
          ...
          <Col sm={6} className="px-1">
            <TextField
              ...
              onChange={(e) => onFormUpdate('numberOfTickets', e.target.value)}
            />
          </Col>
          <Col sm={6} className="px-1">
            <TextField
          ...
          <Col sm={12} className="px-1">
            <TextField
              ...
              onChange={(e) => handleAmountChange('totalPaid', e.target.value)}
            />
          </Col>
          <Col sm={12} className="px-1">
          ...
          <Col>
            ...
            <p>
              * You agree to receive email communication from us by submitting
              ...
              stored with us. We reserve the right to share the information with
              affiliated groups.
            </p>
          </Col>
          <Col sm={12} className="px-1">
